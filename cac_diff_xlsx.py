...
if __name__ == "__main__":
    # 1. 定义XLSX文件参数
    xlsx_path = r"D:\users\gxu\spur_scan\260311\add_pwr_diff_6\2G\40m\vht\2G_40m_vht_spur.xlsx"
    base_row_idx = 0   # 指定第3行（行号从0开始）为基准行
    start_col_idx = 1   # 从第4列（列号从0开始）开始计算差值
    output_path = r"D:\users\gxu\spur_scan\260311\add_pwr_diff_6\2G\40m\vht\2G_40m_vht_spur_diff.xlsx"
