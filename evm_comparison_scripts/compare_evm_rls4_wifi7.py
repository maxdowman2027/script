...
def main():
    # 文件路径
    rls4_file = r"D:\chip_test\dev\xian_test\Xian-Esp-Test-Scripts\py_script_fpga_tx_wifi7\Log\wifi_tx_rls4\vht_ht_compare\merged_tx_result.xlsx"
    wifi7_file = r"D:\chip_test\dev\xian_test\Xian-Esp-Test-Scripts\py_script_fpga_tx_wifi7\Log\wifi_tx\20260407\vht_ht_2\merged_tx_result.xlsx"

    # 输出目录
    output_dir = r"D:\chip_test\dev\xian_test\Xian-Esp-Test-Scripts\py_script_fpga_tx_wifi7\Log\wifi_tx\20260407\vht_ht_2\rls4_wifi7_evm_comparison"
    ...
    print("\n=== Start analyzing WiFi7 version data ===")
    try:
...
def generate_html_report(comparison_result, output_dir, output_file):
    ...
    <html>
    <head>
        <title>RLS4.0 vs WiFi7 Version EVM Comparison Analysis</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <h1>RLS4.0 与 WiFi7 版本 EVM 对比分析</h1>
    ...
    html_content += '''
            ...
            <div class="section">
                <h2>5. 文件描述</h2>
                <ul>
                    <li><strong>分析脚本:</strong> compare_evm_rls4_wifi7.py</li>
                    <li><strong>RLS4.0版本文件:</strong> D:/chip_test/dev/xian_test/Xian-Esp-Test-Scripts/py_script_fpga_tx_wifi7/Log/wifi_tx_rls4/vht_ht_compare/merged_tx_result.xlsx</li>
                    <li><strong>WiFi7版本文件:</strong> D:/chip_test/dev/xian_test/Xian-Esp-Test-Scripts/py_script_fpga_tx_wifi7/Log/wifi_tx/20260407/vht_ht_2/merged_tx_result.xlsx</li>
