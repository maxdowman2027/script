...
# =============================================================================
INPUT_CSV = r"D:\test_data\rls4\260713_dpd\tone_adc\adc_tone_iladata.csv"
OUTPUT_PDF = ""  # 空 → <INPUT_CSV stem>.pdf（同 myplot: fname + '.pdf'）

BW_MHZ = 20  # phymd
CH_FREQ_MHZ = 2462  # chan
FREQCW_MHZ = 2467  # freqcw
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="myplot.psd_plot_rx_cal with config + CSV input")
    p.add_argument("input", nargs="?", default=INPUT_CSV, help="I/Q CSV file")
    ...
    p.add_argument("-o", "--output-pdf", default=OUTPUT_PDF, help="PDF stem (no .pdf suffix)")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    fname = args.output_pdf if args.output_pdf else str(csv_path.with_suffix(""))
    ...
    print(
        f"[RESULT] Fs={fs_used}MHz decimate={decimate} bit_width={args.bit_width} "
